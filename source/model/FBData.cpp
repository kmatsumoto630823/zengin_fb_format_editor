...
FBData::FBData(const FBAttrsArray& attrs_array) : 
m_grid_array
{
...
bool FBData::open_file(const std::string& path)
{
...
bool FBData::save_file(const std::string& path)
{
...
bool FBData::from_text(const std::string& text)
{
    auto mod_text = text;
...
FBData& FBData::set_newline(FBNewLine newline)
{
    m_newline = newline;
    return *this;
}

FBNewLine FBData::get_newline() const
{
    return m_newline;
}