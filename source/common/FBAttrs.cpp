...
const FBAttrsArray ATTRS_ARRAY_SOHFURI =
{
    ...
    FBAttrs
    {
        ...
        {12, 103, 17, 'D', _DM_, '-', _DM_, "ダミー",       "スペースとする"}
    }
    ,
    ...
    FBAttrs
    {
        ...
        {15, 113,  7, 'D', _DM_, '-', _DM_, "ダミー",         "スペースとする"}
    }
    ,
    ...
    FBAttrs
    {
        ...
        { 3, 19, 101, 'D', _DM_, '-', _DM_, "ダミー",     "スペースとする"}
    }
    ,
    ...
    FBAttrs
    {
        ...
        { 1, 1, 119, 'D', _DM_, '-', _DM_, "ダミー",     "スペースとする"}
    }
};
...
const FBAttrsArray ATTRS_ARRAY_KYUYO_SHOYO =
{
    ...
    FBAttrs
    {
        ...
        {13, 111,  9, 'D', _DM_, '-', _DM_, "ダミー",         "スペースとする"}
    }
    ,
...
const FBAttrsArray ATTRS_ARRAY_FURIKAE =
{
    ...
    FBAttrs
    {
        ...
        { 3,  20,  3, 'N', _NM_, 'M', _NM_, "支店番号",       "統一店番号"},
        { 4,  23, 15, 'C', _KN_, 'O', _KN_, "支店名",         ""},
        { 5,  38,  4, 'D', _DM_, '-', _DM_, "ダミー",         "スペースとする"},
        { 6,  42,  1, 'N', _NM_, 'M', _NM_, "預金種目",       "「１」：普通預金\r\n「２」：当座預金\r\n「３」：納税準備預金\r\n「９」：その他"},
        { 7,  43,  7, 'N', _NM_, 'M', _NM_, "口座番号",       ""},
        { 8,  50, 30, 'C', _KN_, 'M', _KN_, "預金者名",       ""},
        ...
        {13, 112,  8, 'D', _DM_, '-', _DM_, "ダミー",         "スペースとする"}
    }
    ,
    ...
    FBAttrs
    {
        ...
        { 7, 55,  65, 'D', _DM_, '-', _DM_, "ダミー",       "スペースとする"}
    }
    ,
