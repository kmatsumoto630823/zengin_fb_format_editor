...
public:
    ...
    std::size_t get_rows_num(FBPart part = FBPart::CURRENT);
    ...
    bool append_row(std::size_t num = 1, FBPart part = FBPart::CURRENT);
    bool insert_row(std::size_t row, std::size_t num = 1, FBPart part = FBPart::CURRENT);
    bool delete_row(std::size_t row, std::size_t num = 1, FBPart part = FBPart::CURRENT);
